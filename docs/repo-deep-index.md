...
## APP files (25)
- `src/app/(protected)/add/page.tsx` - 700 lines | exports:AddPlantPage | db:circle_member, plant, plant_log
- `src/app/(protected)/circles/[id]/page.tsx` - 961 lines | exports:CircleDetailPage | db:circle, circle_activity, circle_activity_reaction, circle_alltime_score, circle_member, circle_weekly_score
- `src/app/(protected)/circles/[id]/settings/page.tsx` - 481 lines | exports:CircleSettingsPage | db:circle, circle_member
- `src/app/(protected)/circles/create/page.tsx` - 258 lines | exports:CircleCreatePage
...
- `src/app/auth/page.tsx` - 709 lines | exports:AuthPage
...
- `src/app/layout.tsx` - 70 lines | exports:RootLayout, metadata, viewport | env:NEXT_PUBLIC_SITE_URL
...
- `src/app/api/recognize/route.ts` - 304 lines | methods:POST | exports:POST | db:plant | env:OPENROUTER_API_KEY
- `src/app/api/sage/menu-max/route.ts` - 688 lines | methods:POST | exports:POST | db:plant | env:OPENROUTER_API_KEY, SAGE_MENU_OPENROUTER_MODEL, SAGE_MENU_TIMEOUT_MS
- `src/app/api/sage/route.test.mjs` - 90 lines
- `src/app/api/sage/route.ts` - 389 lines | methods:POST | exports:POST | env:OPENROUTER_API_KEY, SAGE_DETERMINISTIC_ONLY, SAGE_OPENROUTER_MODEL, SAGE_OPENROUTER_TIMEOUT_MS
...
- `src/app/api/voice-log/route.ts` - 449 lines | methods:POST | exports:POST | env:OPENROUTER_API_KEY, VOICE_OPENROUTER_MODEL, VOICE_OPENROUTER_TIMEOUT_MS
...
- `src/components/GutHealthPopover.tsx` - 72 lines | exports:GutHealthPopover
...
- `src/components/PhotoRecognitionModal.tsx` - 373 lines | exports:PhotoRecognitionModal
...
- `src/components/ProtectedLayout.tsx` - 263 lines | exports:ProtectedLayout, useApp | db:member
- `src/components/SageChat.tsx` - 187 lines | exports:SageChat
- `src/components/SageMenuLogReviewSheet.tsx` - 193 lines | exports:SageMenuLogReviewSheet | db:plant_log
- `src/components/SageMenuMax.tsx` - 391 lines | exports:SageMenuMax
- `src/components/VoiceLogModal.tsx` - 861 lines | exports:VoiceLogModal
- `src/components/ui/dialog.tsx` - 62 lines
- `src/components/ui/sheet.tsx` - 62 lines

## LIB files (38)
- `src/lib/account/rateLimit.ts` - 108 lines | exports:checkRateLimit, RateLimitResult | db:rpc:consume_rate_limit
- `src/lib/account/requestMeta.ts` - 34 lines | exports:getRequestMeta, getRequestOrigin | env:NEXT_PUBLIC_SITE_URL
...
- `src/lib/api/errors.ts` - 47 lines | exports:apiError, ApiErrorCode
- `src/lib/api/safeRemoteText.ts` - 214 lines | exports:fetchSafeRemoteText
- `src/lib/api/telemetry.ts` - 44 lines | exports:createApiTelemetry
- `src/lib/circles.test.mjs` - 143 lines | env:NEXT_PUBLIC_SITE_URL
- `src/lib/circles.ts` - 346 lines | exports:generateInviteCode, getShareUrl, isValidCircleId, isValidInviteCode, validateJoinCirclePayload, detectLeaderboardDiscrepancies... | env:NEXT_PUBLIC_SITE_URL
...
- Supabase tables/RPC: account_deletion_request, account_export_request, account_security_event, circle, circle_activity, circle_activity_reaction, circle_alltime_score, circle_member, circle_weekly_score, member, plant, plant_log, rpc:consume_rate_limit, rpc:join_circle
